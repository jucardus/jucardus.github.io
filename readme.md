...
**25-10-28** - Estamos intentando añadir un recuadro de busca a la página (https://jucardus.github.io/github). La página genera su contenido con JavaScript, a partir del repositorio (https://github.io/jucardus/jucardus.github.io), de modo que el trámite no es tan simple.
