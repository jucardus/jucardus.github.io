...
**25-11-01** - Acabo de cambiar la página de prueba _github.html_ a _index.html_ (visible en _[jucardus.github.io](https://jucardus.github.io)_). Se trata de un renderizador de documentos en formato MD (_markdown_) a HTML, de modo que las subpáginas *.md alojadas en GitHub sean navegables como un sitio web. El renderizador aún necesita ciertas implementaciones y detalles adicionales, pero la versión actual es completamente funcional y puede ser usada gratuitamente para implementar tu propio sitio web.
