...
El t?rmino ?? (??) se compone de ? [l?o] 'viejo', 'experimentado', usado como prefijo para mostrar respeto, y ? (?) [sh?] 'profesor', 'maestro', 'experto'. Es una forma respetuosa de dirigirse a los profesores, maestros o a cualquier persona que funge de instructor.

### Traducciones

* instructor
* profesor, maestro
* maestro, gur? (para elogiar coloquialmente a alguien - Sin?nimos: ?? (??) [d?sh?], ?? [d?sh?n])

### Frases de ejemplo

* ????????? (?????????) [T? sh? l?osh?, sh? b? sh??] ? ?l es profesor, ?verdad?
